...
imap <F2> <Esc>:SCCompileRun -std=c++17 -g -Werror -Wall -Wextra -pedantic -Wshadow -O2 -o $(FILE_TITLE)$<cr>
nmap <F2>      :SCCompileRun -std=c++17 -g -Werror -Wall -Wextra -pedantic -Wshadow -O2 -o $(FILE_TITLE)$<cr>
imap <F3> <Esc>:SCCompileRun -std=c++17 -g -Werror -Wall -Wextra -pedantic -Wshadow -Ofast -march=native -o $(FILE_TITLE)$<cr>
nmap <F3>      :SCCompileRun -std=c++17 -g -Werror -Wall -Wextra -pedantic -Wshadow -Ofast -march=native -o $(FILE_TITLE)$<cr>
