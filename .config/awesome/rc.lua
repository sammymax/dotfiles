...
vicious.register(mymem, vicious.widgets.mem, " RAM: $1% ($2MB/$3MB)  | ", 5)

mycpu = awful.widget.graph()
mycpu:set_width(50)
mycpu:set_background_color("#494B4F")
mycpu:set_color({ type = "linear", from = { 0, 0 }, to = { 50, 0 },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "F3",     function() awful.util.spawn("keepass2") end,
              {description="Keepass"}),
